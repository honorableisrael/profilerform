    ...
    <div>
      <Container fluid>
        <Row className="sdnnavrow">
          <UserdashboardSideBar hideads={true} loans={true} />
          <Col md={9} className="udshboard">
            ...
            <div className="proffl">Personal Loans</div>
            <Col md={12} className="">
              <div className="selg"></div>
              <div className="cominga">
                <img src={comingsoon} className="comingsoon2 animated fadeIn" />
                <div className="ssoon animated pulse">Coming Soon</div>
              </div>
            </Col>
          </Col>
        </Row>
